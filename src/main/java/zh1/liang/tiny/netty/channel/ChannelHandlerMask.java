...
public class ChannelHandlerMask {
    ...
    //key channelHandler, value 关心的事件
    //一个线程一个
    private static final ThreadLocal<Map<Class<? extends ChannelHandler>, Integer>> MASKS_THREADLOCAL =
    ...
    static int mask(Class<? extends ChannelHandler> clazz) {
        ...
        Map<Class<? extends ChannelHandler>, Integer> cache = MASKS_THREADLOCAL.get();
