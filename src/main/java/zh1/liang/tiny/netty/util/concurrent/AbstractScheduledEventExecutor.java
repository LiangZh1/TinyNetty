...
import zh1.liang.tiny.netty.util.internal.DefaultPriorityQueue;
import zh1.liang.tiny.netty.util.internal.ObjectUtil;
import zh1.liang.tiny.netty.util.internal.PriorityQueue;
...
public abstract class AbstractScheduledEventExecutor extends AbstractEventExecutor{
    ...
    /**
     * 该方法会在NioEventLoop中被调用，用来判断是否存在已经到期了的定时任务。实际上就是得到定时任务队列中的首任务
     * 判断其是否可以被执行了
     */
